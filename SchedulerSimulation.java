...
class Process implements Runnable {
    ...
    public Process(String name, int burstTime, int timeQuantum) {
        ...
        this.priority = 1 + new Random().nextInt(5); // Feature 1 Initialize priority randomly (1 to 5)
        // Feature 3:
    ...
    public void run() {
        ...
        totalWaitingTime = System.currentTimeMillis() - arrivalTime; // Feature 3:
...
public class SchedulerSimulation {
    ...
    static int contextSwitches = 0; // Feature 2: Count context switches

    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445052099; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        while (!processQueue.isEmpty()) {
            ...
            contextSwitches++; // Feature 2 : incremnt context switch count
